...
<body>
    ...
    <section id="header">
        ...
        <div id="show-menu">
            <a href="viewcart.html"><i class="fas fa-bag-shopping"></i></a>
            <i id="menu-bar" class="fas fa-outdent"></i>
        </div>
    </section>

<!-- about us section.... -->
    <section id="ImgBanner" class="about-header">  
    ...
    <section id="about" class="section-p1">
        ...
        <div class="description">
            <h2>Who We Are ?</h2>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Labore consectetur quasi nemo, atque libero nesciunt veniam fugiat nulla rem dicta ducimus nobis repellendus ipsa corrupti quod quia deserunt nostrum doloribus ex dolorem. Facere provident adipisci nemo dicta doloremque officiis! Id.</p>
        </div>
    </section>

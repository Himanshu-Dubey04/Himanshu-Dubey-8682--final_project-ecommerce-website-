...
<head>
    ...
    <title>Ecommerce Website Home Page</title>
...
<body>
    ...
    <section id="header">
        ...
        <div>
            <ul id="navbar">
                ...
                <div class="dropdown">
                    <button class="dropbtn">
                        <i class="fa fa-caret-down other" >
    ...
    <section id="fe-products" class="section-p1">
        ...
        <?php 
            ...
            while($row = mysqli_fetch_array($record)){
                ...
                $CheckPage = $row['Product_Category'];
                if($CheckPage === 'Home')
                {
                    echo "
                    <div class='box' >
                        <form action='insertcart.php' method='POST' class='form'>
                            <img src='../PRODUCTS/{$row['Product_Image']}' onclick='window.location.href=\"singleproduct.php?id={$row['ID']}\"'>
                                    <div class='des'>
                                        <span>addidas</span>
    ...
    <!-- banner2.....  -->
    <section id="mid-banner" class="section-m1">
